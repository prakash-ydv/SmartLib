...
const CampusAccessGate = ({ children }) => {
  ...
  if (accessStatus.granted) {
    return (
      <>
        {/* Optional: Success Banner (can be hidden) */}
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 lg:p-10">
            ...
            <div className="space-y-3 mb-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-gray-700 pt-1">Scan the QR code at the library counter</p>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-gray-700 pt-1">Ensure location services are enabled on your device</p>
              </div>
            </div>
