 ...
 * @param {object} stats - Stats object { totalBooks, availableBooks, unavailableBooks }
 * @param {number} categoriesCount - Total categories count
 */
function BookStats({ stats, categoriesCount }) {
  // Stats passed from parent (Server Data)
  const {
    totalBooks = 0,
    availableBooks = 0,
    unavailableBooks = 0,
